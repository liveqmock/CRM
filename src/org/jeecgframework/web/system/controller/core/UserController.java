...
public class UserController {
	...
	* @throws
	 ...
	 * @return
	 */
	@RequestMapping(params = "sharedUser")
	public String sharedUser() {
		return "com/buss/sharedUser";
	}
	@RequestMapping( params = "sharedUserDatagrid")
	public void sharedUserDatagrid(HttpServletRequest request , DataGrid dataGrid , HttpServletResponse response){
		CriteriaQuery cq = new CriteriaQuery(TSUser.class, dataGrid);
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
	}
