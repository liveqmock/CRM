...
public class SystemServiceImpl extends CommonServiceImpl implements SystemService {
	...
	@Override
	public List<String> getParentDepId(String depId){
		List<Map<String, Object>> list = findForJdbc(" select parentdepartid from t_s_depart where id = ? ", depId);
		for(Map<String, Object> map :list){
			String parentId = (String)map.get("parentdepartid");
			if(parentId!=null){
				depIds.add(parentId);
				return getParentDepId(parentId);	
			}
		}
		return depIds;			
	}
