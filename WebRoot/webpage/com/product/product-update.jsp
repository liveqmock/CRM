...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="productController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="type" type="list"
						typeGroupCode="" defaultVal="${productPage.type}" hasLabel="false"  title="类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				 <textarea id="remark" name="remark">${productPage.remark}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="creatdate" name="creatdate" type="text" style="width: 150px" 
					                ...
					                value='<fmt:formatDate value='${productPage.creatdate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="owner" type="list"
						dictTable="t_s_base_user" dictField="id" dictText="realname" defaultVal="${productPage.owner}" hasLabel="false"  title="管理人员"></t:dictSelect>     
				<span class="Validform_checktip"></span>
