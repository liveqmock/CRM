...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="bussLeadController.do?doAdd">
					...
					<input id="delStatus" name="delStatus" type="hidden" value="1">
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="source" type="list"
						typeGroupCode="lsource"  hasLabel="false"  title="来源"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="level" type="list"
						typeGroupCode="level"  hasLabel="false"  title="意向级别"></t:dictSelect>     
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">意向级别</label>
			</td>
			<td align="right">
				<label class="Validform_label">分配状态:</label>
			</td>
			<td class="value">
					<t:dictSelect field="distributionstatus" type="list"
						typeGroupCode="assigstatu"  hasLabel="false"  title="分配状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="leadstatus" type="list"
						typeGroupCode="lstatus"  hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="distribution" type="list"
						dictTable="t_s_base_user" dictField="id" dictText="realname"  hasLabel="false"  title="分配人"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				 <textarea id="remark" name="remark" style="width: 500px;height: 60px"></textarea>
				<span class="Validform_checktip"></span>
