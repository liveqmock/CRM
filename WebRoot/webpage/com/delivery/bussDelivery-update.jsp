...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bussDeliveryController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="contractname" name="contractname" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${bussDeliveryPage.contractname}'>
						...
						<td class="value">
						     	 <input id="accountname" name="accountname" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${bussDeliveryPage.accountname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="creatdate" name="creatdate" type="text" style="width: 150px" 
						      						 ...
						      						 value='<fmt:formatDate value='${bussDeliveryPage.creatdate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="address" name="address" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${bussDeliveryPage.address}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deliverytotal" name="deliverytotal" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${bussDeliveryPage.deliverytotal}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="deliverydate" name="deliverydate" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${bussDeliveryPage.deliverydate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remark" name="remark">${bussDeliveryPage.remark}</textarea>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="contractno" name="contractno" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${bussDeliveryPage.contractno}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/delivery/bussDelivery.js"></script>		