...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bussAccountController.do?doAccountShared" tiptype="1">
 					<input id="customerIds" name="customerIds" type="hidden" value="${customerIds}">  <!-- 资源对象 -->
		...
		<table style="width: 450px;"  class="formtable">				
				...
				<tr id="dep" style="display: none"> 	   
					...
					<td class='value' >
							<t:dictSelect field='*' type='list' id="depId"
