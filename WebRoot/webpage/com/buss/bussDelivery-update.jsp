...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="bussDeliveryController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" colspan="3">
				 <textarea id="remark" name="remark" rows="6"  style="width: 500px" >${bussDeliveryPage.remark}</textarea>
				<span class="Validform_checktip"></span>
