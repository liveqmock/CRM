...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="bussInvoiceController.do?doAdd">
					<input id="id" name="id" type="hidden" value="${bussInvoicePage.id }">
					<input id="contract" name="contract" type="hidden" value="${bussInvoicePage.contract }">
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="type" type="list"
						typeGroupCode="itype"  hasLabel="false"  title="类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="istatus"  hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="createby" type="list"
						dictTable="t_s_base_user" dictField="id" dictText="realname"  hasLabel="false"  title="开票人"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="bussInvoiceController.do?bussDeliveryitemList&id=${bussInvoicePage.id}&id=${bussInvoicePage.id}" icon="icon-search" title="发票明细" id="bussDeliveryitem"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
 ...
 <script src = "webpage/com/buss/bussInvoice.js"></script>	