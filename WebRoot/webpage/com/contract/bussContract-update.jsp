...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="bussContractController.do?doUpdate">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="quantily" name="quantily" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${bussContractPage.quantily}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="accountname" name="accountname" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${bussContractPage.accountname}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="address" name="address" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${bussContractPage.address}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				 <textarea id="remark" name="remark">${bussContractPage.remark}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="collect" name="collect" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${bussContractPage.collect}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="uncollect" name="uncollect" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${bussContractPage.uncollect}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="ceatedate" name="ceatedate" type="text" style="width: 150px" 
					                ...
					                value='<fmt:formatDate value='${bussContractPage.ceatedate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
				<span class="Validform_checktip"></span>
 ...
 <script src = "webpage/com/buss/bussContract.js"></script>	