...
<body>
        ...
        <div class="inner">
            ...
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div class="tip">
                        <input class="userName" name="userName" type="text" id="userName" title="用户名" iscookie="true" value="crm" nullmsg="请输入用户名!" />
                    </div>
                    <div class="tip">
                    ...
                    <div class="tip">
                        ...
                        <div style="float: right; margin-left:-220px; margin-right: 35px;">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="http://weibo.com/534557630/home" title="@终位线">365IME</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="http://weibo.com/534557630/home" title="@终位线">365IME</a></span></div>
    </div>
    <!-- Link JScript-->
