...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="#" title="SpringMVC Framework">365IME团队</a></li>
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度) 技术支持:<a title="SpringMVC Framework" href="#">365IME团队</a></li>
</ul>
</div>
</footer>
